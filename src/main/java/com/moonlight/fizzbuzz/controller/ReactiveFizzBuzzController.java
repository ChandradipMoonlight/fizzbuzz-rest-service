...
public class ReactiveFizzBuzzController {
    @Autowired
    private FizzBuzzReactiveService fizzBuzzReactiveService;
    ...
    public Flux<String> getFizzBuzzAlgo(@RequestParam(defaultValue = "3") int int1,
        ...
        return fizzBuzzReactiveService.getAsyncEncryptedResultUsingFizzBuzzAlgorithm(fizzBuzzRequest);
    }

    @GetMapping(value = "/statistic")
    public Mono<Map<String, Object>> getStatistics() {
        return fizzBuzzReactiveService.getAsyncStatistics();
    }
